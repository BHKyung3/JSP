...
<form action "mypage.do" method="post" name="frm" style="text-align: center;">
	...
	<table style="margin: 0 auto;" border=1px solid black; width=50%>
			...
			<tr>
				<td>아이디 </td>
				<td id><input type="text" name="id" value="${eVo.id}" readonly="readonly"></td>
			</tr>
			<tr>
				<td>비밀번호</td>
				<td id><input type="password" name="pass" value="${eVo.pass}"></td>
			</tr>
			<tr>
				<td>이름</td>
				<td id><input type="text" name="name" value="${eVo.name}"></td>
			</tr>
			<tr>
				<td>권한</td>
				<td>
